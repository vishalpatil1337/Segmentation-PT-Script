# Execute only the part "cat segment1_tcp.bat"
with open('subnets_segment1_tcp.bat', 'r') as f:
    segment1_content = f.read()
print(segment1_content)

# Save the entire script along with the output of "cat segment1_tcp.bat" to a new file called output.bat
with open('final_segment1_tcp.bat', 'w') as output_file:
